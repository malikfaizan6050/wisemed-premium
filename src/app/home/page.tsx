...
// The public marketing landing page. `/` now serves the CRM login portal, so
// the proxy rewrites `/` to this route for the marketing hosts; visitors still
// see the address as `/`, which is why the canonical path below stays "/".
